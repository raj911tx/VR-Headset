...
oxr_verify_khr_simple_controller_subpath(const char *str, size_t length)
{
	...
	case 31:
		if (strcmp(str, "/user/hand/right/input/aim/pose") == 0) {
			return true;
...
oxr_verify_google_daydream_controller_subpath(const char *str, size_t length)
{
	...
	case 32:
		if (strcmp(str, "/user/hand/left/input/trackpad/x") == 0) {
			return true;
...
oxr_verify_microsoft_motion_controller_subpath(const char *str, size_t length)
{
	...
	case 40:
		if (strcmp(str, "/user/hand/left/input/trackpad/dpad_left") == 0) {
			return true;
		} else if (strcmp(str, "/user/hand/left/input/thumbstick/dpad_up") == 0) {
			return true;
		} else if (strcmp(str, "/user/hand/left/input/trackpad/dpad_down") == 0) {
			return true;
		} else {
	...
	case 42:
		if (strcmp(str, "/user/hand/left/input/thumbstick/dpad_left") == 0) {
			return true;
	...
	case 43:
		if (strcmp(str, "/user/hand/left/input/thumbstick/dpad_right") == 0) {
			...
			return true;
		} else if (strcmp(str, "/user/hand/right/input/trackpad/dpad_center") == 0) {
			return true;
		} else {
			return false;
		}
...
oxr_verify_microsoft_xbox_controller_subpath(const char *str, size_t length)
{
	...
	case 35:
		if (strcmp(str, "/user/gamepad/input/thumbstick_left") == 0) {
			...
			return true;
		} else if (strcmp(str, "/user/gamepad/input/dpad_down/click") == 0) {
			return true;
		} else {
			return false;
		}
	...
	case 33:
		if (strcmp(str, "/user/gamepad/output/haptic_right") == 0) {
			return true;
	...
	case 39:
		if (strcmp(str, "/user/gamepad/input/trigger_right/value") == 0) {
			return true;
	...
	case 45:
		if (strcmp(str, "/user/gamepad/input/thumbstick_left/dpad_down") == 0) {
			return true;
		} else if (strcmp(str, "/user/gamepad/input/thumbstick_left/dpad_left") == 0) {
			return true;
		} else {
			return false;
		}
	case 46:
		if (strcmp(str, "/user/gamepad/input/thumbstick_left/dpad_right") == 0) {
			return true;
	...
	case 38:
		if (strcmp(str, "/user/gamepad/input/thumbstick_right/x") == 0) {
			return true;
...
oxr_verify_oculus_go_controller_subpath(const char *str, size_t length)
{
	...
	case 30:
		if (strcmp(str, "/user/hand/right/input/trigger") == 0) {
			return true;
		} else if (strcmp(str, "/user/hand/left/input/trackpad") == 0) {
			return true;
		} else if (strcmp(str, "/user/hand/left/input/aim/pose") == 0) {
...
oxr_verify_valve_index_controller_subpath(const char *str, size_t length)
{
	...
	case 38:
		if (strcmp(str, "/user/hand/left/input/trackpad/dpad_up") == 0) {
			return true;
		} else if (strcmp(str, "/user/hand/left/input/thumbstick/touch") == 0) {
			return true;
		} else if (strcmp(str, "/user/hand/left/input/thumbstick/click") == 0) {
			return true;
		} else {
...
oxr_verify_microsoft_hand_interaction_subpath(const char *str, size_t length)
{
	...
	case 35:
		if (strcmp(str, "/user/hand/left/input/squeeze/value") == 0) {
			return true;
		} else if (strcmp(str, "/user/hand/right/input/select/value") == 0) {
			return true;
		} else {
			return false;
		}
...
oxr_verify_mndx_ball_on_a_stick_controller_subpath(const char *str, size_t length)
{
	...
	case 28:
		if (strcmp(str, "/user/hand/left/input/select") == 0) {
			...
			return true;
		} else if (strcmp(str, "/user/hand/right/input/start") == 0) {
			return true;
		} else {
			return false;
		}
	...
	case 33:
		if (strcmp(str, "/user/hand/left/input/start/click") == 0) {
			return true;
	...
	case 39:
		if (strcmp(str, "/user/hand/left/input/circle_mndx/click") == 0) {
			return true;
	...
	case 38:
		if (strcmp(str, "/user/hand/left/input/body_center_mndx") == 0) {
			return true;
		} else if (strcmp(str, "/user/hand/left/input/cross_mndx/click") == 0) {
			return true;
		} else {
			return false;
		}
	...
	case 36:
		if (strcmp(str, "/user/hand/left/input/ball_mndx/pose") == 0) {
			return true;
		} else if (strcmp(str, "/user/hand/right/input/trigger/value") == 0) {
			return true;
	...
	case 37:
		if (strcmp(str, "/user/hand/right/output/haptic/haptic") == 0) {
			return true;
		} else if (strcmp(str, "/user/hand/right/input/ball_mndx/pose") == 0) {
			return true;
		} else {
			return false;
		}
...
oxr_verify_mndx_hydra_subpath(const char *str, size_t length)
{
	...
	case 34:
		if (strcmp(str, "/user/hand/left/input/thumbstick/x") == 0) {
			return true;
		} else if (strcmp(str, "/user/hand/left/input/bumper/click") == 0) {
			return true;
		} else if (strcmp(str, "/user/hand/left/input/thumbstick/y") == 0) {
			return true;
		} else {
	...
	case 30:
		if (strcmp(str, "/user/hand/right/input/4/click") == 0) {
			return true;
	...
	case 24:
		if (strcmp(str, "/user/hand/right/input/3") == 0) {
			return true;
		} else if (strcmp(str, "/user/hand/right/input/2") == 0) {
			return true;
...
struct profile_template profile_templates[12] = { // array of profile_template
	{ // profile_template
	...
	{ // profile_template
		...
		.bindings = (struct binding_template[]){ // array of binding_template
			...
			{ // binding_template 1
				.subaction_path = "/user/hand/left",
				.steamvr_path = "/input/squeeze/click",
	...
	{ // profile_template
		...
		.bindings = (struct binding_template[]){ // array of binding_template
			...
			{ // binding_template 12
				.subaction_path = "/user/gamepad",
				.steamvr_path = "/input/thumbstick_left/click",
			...
			{ // binding_template 13
				.subaction_path = "/user/gamepad",
				.steamvr_path = "/input/thumbstick_left",
				.localized_name = "Left Thumbstick",
				.paths = { // array of paths
			...
			{ // binding_template 14
				.subaction_path = "/user/gamepad",
				.steamvr_path = "/input/thumbstick_right/click",
			...
			{ // binding_template 15
				.subaction_path = "/user/gamepad",
				.steamvr_path = "/input/thumbstick_right",
				.localized_name = "Right Thumbstick",
				.paths = { // array of paths
	...
	{ // profile_template
		...
		.bindings = (struct binding_template[]){ // array of binding_template
			...
			{ // binding_template 5
				.subaction_path = "/user/hand/left",
				.steamvr_path = "/input/squeeze/value",
				.localized_name = "Squeeze",
				.paths = { // array of paths
	...
	{ // profile_template
		...
		.bindings = (struct binding_template[]){ // array of binding_template
			...
			{ // binding_template 6
				.subaction_path = "/user/hand/left",
				.steamvr_path = "/input/squeeze/force",
				.localized_name = "Squeeze",
				.paths = { // array of paths
	...
	{ // profile_template
		...
		.bindings = (struct binding_template[]){ // array of binding_template
			...
			{ // binding_template 11
				.subaction_path = "/user/hand/left",
				.steamvr_path = "/input/body_center_mndx",
